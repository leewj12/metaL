...
public class AdminController {
    ...
    @GetMapping("/admin/KDT/admindashboard")
    public String ad() {
        return "/admin/KDT/admindashboard";
    }

    @GetMapping("/admin/KDT/course/update")
    public String adu() {
        return "/admin/KDT/courseupdate";
    }

    @GetMapping("/admin/KDT/sessiond")
    public String tlqkf() {
        return "/admin/KDT/sessiondetail";
    }

    @GetMapping("/admin/KDT/sessionu")
    public String asdjknkjsdnjknadgsk() {
        return "/admin/KDT/sessionupdate";
    }

    @GetMapping("/admin/KDT/certi")
    public String asdjknkjsdndgsk() {
        return "/admin/KDT/certi";
    }
}